...
color color1 = #4f77e4;  //color(255, 0, 0); //backgroundfill(colorT)
color color2 = #410baa;  //color(84, 14, 176);        //top and buttons
color color3 = #00a18a;  //color(0, 191, 57);        //cursor
color colorT = #71e0d1;
